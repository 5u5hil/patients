...
function addOther(name, field) {
    var htmlStr = '';
    htmlStr = "<label class='item item-input item-floating-label'><input type='text' name='" + name + " ng-model='record." + name + "' placeholder='Please Enter " + field + "' id='"+name+"1'/></label><br/>";
